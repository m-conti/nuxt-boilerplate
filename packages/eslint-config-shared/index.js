...
module.exports = {
  ...
  rules: {
    ...
    'no-extra-semi': 'warn', //disallow unnecessary semicolons (recommended) (fixable)
    ...
    'no-warning-comments': [ 'error', { terms: ['todo', 'fixme'], location: 'start' }], //disallow usage of configurable warning terms in comments e.g. TODO or FIXME
    ...
    'no-unused-vars': ['warn', { vars: 'local', args: 'after-used', varsIgnorePattern: 'key', argsIgnorePattern: '^_'}], //disallow declaration of variables that are not used in the code (recommended)
    'no-use-before-define': 'off', //disallow use of variables before they are defined

    /* Node.js */
    'callback-return': 'warn', //enforce return after a callback
    ...
    'indent': 'off', //specify tab or space width for your code (fixable)
    ...
    'semi': ['warn', 'always'], //require or disallow use of semicolons instead of ASI (fixable)
    ...
    /* Forbid https://github.com/jfmengels/eslint-plugin-fp/tree/master#eslint-plugin-fp- */
    ...
    'fp/no-get-set': 'off', // Forbid the use of getters and setters.
    'fp/no-let': 'warn', // Forbid the use of let.
    ...
    'fp/no-proxy': 'off', // Forbid the use of Proxy.
    'fp/no-rest-parameters': 'off', // Forbid the use of rest parameters.
    'fp/no-this': 'off', // Forbid the use of this.
